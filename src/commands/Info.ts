...
export default new class Info extends Command {
  ...
  public async run(client: Client, message: Message, args: Args, guild: Client.Guild): Promise<void> {
    ...
    const embed = Embed.info(message.author)
      .addField('ArctBot', `Hello, I'm ArctBot! I am a discord bot made by ${(await client.fetchUser('470502898758057986')).tag} to help make your server better!`)
      ...
      .addField('How To Use', `All of my commands are under the prefix '$' by default. To learn more about what commands I have, use $help. To gain more information on a single command, use $help [command]`)
      .addField('Elevation', 'Some commands require moderator or administrator permissions. To show me who you\'ve picked as moderators and administrators, use the settings commands and update roles.moderator and roles.administrator to their respective roles.')
